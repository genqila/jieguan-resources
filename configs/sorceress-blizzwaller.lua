...
Config.CharacterName  = "Blizzwaller" -- Name of the character. Bot will automatically find character and select it. **** CASE SENSITIVE ***
...
Config.AttackSkill = {
  ...
  51, -- Alternate skill for immune monsters
