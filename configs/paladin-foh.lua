...
Config.CharacterName  = "FoH" -- Name of the character. Bot will automatically find character and select it. **** CASE SENSITIVE ***
...
Config.CustomAttack = {
  -- Halls of Vaught
  [682] = { 121, 124 }, -- minion9 (Slayer)
  [526] = { 121, 124 }, -- nihlathakboss (Nihlathak)
}
