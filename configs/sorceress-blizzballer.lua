...
Config.CharacterName  = "Blizzballer" -- Name of the character. Bot will automatically find character and select it. **** CASE SENSITIVE ***
...
Config.AttackSkill = {
  ...
  47, -- Primary untimed skill for bosses. Use -1 if above skill is an untimed skill
  59, -- Primary skill for other monsters
  47, -- Primary untimed skill for other monsters. Use -1 if above skill is an untimed skill
